            ...
            <div class="col">
                <div class="row ">
                    <div class="col d-flex justify-content-center">
                        <p class="text_header6 animate__animated animate__bounce">Супутнi товари</p>
                    </div>
                </div>
...
<div class="container my-5">
    <div class="row">
        <div class="col-3 ps-5">
            <form action="/main/filter?page=1" method="GET">
                ...
                <p class="text_header12"><input type="checkbox" class="form-check-input p-0 my-2" name="filter-tovar[]" value="pump_new">Пiдсклянники для кулера</p>
                    ...
                    <button type="submit" class="btn btn-outline-primary">Filter1</button>
